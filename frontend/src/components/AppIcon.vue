...
const ICONS = {
  ...
  // 在线搜索：云朵意象，与「重复校验」的放大镜明确区分
  cloud: '<path d="M18 10h-1.26A8 8 0 1 0 9 20h9a5 5 0 0 0 0-10z"/>',
  // 网络设置（代理）：用经纬球而不是 cloud —— cloud 已经被「在线源」占用，
  // 两个分类必须一眼分得开。
  ...
  // 外观 / 调色：设置页「外观」分类用
  palette:
    '<path d="M12 2a10 10 0 0 0 0 20c1.1 0 2-.9 2-2 0-.5-.2-1-.5-1.3-.3-.4-.5-.8-.5-1.2 0-1.1.9-2 2-2h2.5A4.5 4.5 0 0 0 22 11 11 11 0 0 0 12 2z"/><circle cx="7.5" cy="10.5" r="1.2" fill="currentColor" stroke="none"/><circle cx="12" cy="7.5" r="1.2" fill="currentColor" stroke="none"/><circle cx="16.5" cy="10.5" r="1.2" fill="currentColor" stroke="none"/>',
  ...
  // 键盘：快捷键设置页用。按键点用零长度线段 + round linecap 画成小圆点（Feather 的惯用写法）
  keyboard:
    '<rect x="2" y="5" width="20" height="14" rx="2"/><path d="M6 9h.01M10 9h.01M14 9h.01M18 9h.01M6 13h.01M18 13h.01"/><path d="M9.5 13h5"/>',
};
